 ...
 * @className com.thunisoft.agent.entity.RequestParameterBean
...
/**
 * RequestParameterBean
 * @description 封装请求参数，主要是 获取zabbix的监控数据
 * @author tlz
...
@AllArgsConstructor
@NoArgsConstructor
public class RequestParameterBean implements Serializable {

    private static final long serialVersionUID = 1518620007654314649L;
